...
const Hero = () => {
  const [bigShoeImg, setBigShoeImg] = useState(
    "https://res.cloudinary.com/dnl8xcyir/image/upload/v1740923012/pngwing.com_4_ev7eje.png"
  );
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-start pt-5">
        <p className="text-xl font-semibold text-coral-red">Our Summer Collection</p>
