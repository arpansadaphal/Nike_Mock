...
const Hero = () => {
  ...
  return (
   <section
  id="home"
  className="relative w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container pb-20 pt-20"
>

      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-25">
        <p className="text-xl font-montserrat text-coral-red pl-5">
          Our Summer collections
        </p>

        <h1 className=" relative mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
